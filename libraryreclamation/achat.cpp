...
*/
QSqlQueryModel * Achat :: recherche_achata(QString valeur)
{
    QSqlQueryModel * model=new QSqlQueryModel();

    QSqlQuery query;

    query.prepare("SELECT * FROM ACHAT WHERE ID LIKE :valeur order by ID");
...
QSqlQueryModel * Achat :: recherche_achatd(QString valeur)
{
    QSqlQueryModel * model=new QSqlQueryModel();

    QSqlQuery query;
  query.prepare("SELECT * FROM ACHAT WHERE ID LIKE :valeur order by ID desc");
    valeur="%"+valeur+"%";
    query.bindValue(":valeur",valeur);
    query.exec();
    model->setQuery(query);
